...
["minecraft", "chiseled_stone_bricks"], ["supplementaries", "stone_lamp"], ["fundamentallyfixed", "stone_pillar"],
...
val endstone = [["create", "cut_ochrum_bricks"], ["create", "cut_ochrum"], ["minecraft", "end_stone"], ["create", "small_ochrum_bricks"], ["minecraft", "end_stone_bricks"],
["upgrade_aquatic", "ochre_kelpy_stone_bricks"], ["create", "cut_ochrum_brick_stairs"], ["create", "cut_ochrum_brick_slab"], ["create", "cut_ochrum_brick_wall"],
["create", "cut_ochrum_stairs"], ["create", "cut_ochrum_slab"], ["create", "cut_ochrum_wall"], ["architects_palette", "cracked_end_stone_bricks"],
["create", "cut_diorite_brick_stairs"], ["create", "cut_diorite_brick_slab"], ["create", "cut_diorite_brick_wall"],
["create", "small_ochrum_brick_stairs"], ["create", "small_ochrum_brick_slab"], ["create", "small_ochrum_brick_wall"],
["minecraft", "end_stone_brick_stairs"], ["minecraft", "end_stone_brick_slab"], ["minecraft", "end_stone_brick_wall"], ["endergetic", "cracked_end_stone_bricks"],
["upgrade_aquatic", "ochre_kelpy_stone_brick_stairs"], ["upgrade_aquatic", "ochre_kelpy_stone_brick_slab"], ["upgrade_aquatic", "ochre_kelpy_stone_brick_wall"],
["endergetic", "chiseled_end_stone_bricks"], ["supplementaries", "stone_lamp"], ["fundamentallyfixed", "end_stone_pillar"],
...
val stoneSets = [stone, deepslate, blackstone, altisite, dripstone, prismarine, endstone] as string[][][];
//,sandstone, red_sandstone, soul_sandstone
...
for stoneSet in stoneSets {
    ...
    craftingTable.addShaped(natStone[1] + "pillar", <item:${pillarItem}> * 2, [
    [<item:${brickItem}>],
    [<item:${brickItem}>]
    ]);
